...
def update_data(html,name,log):
    ...
    df = pd.read_csv('unemployment_scraper/unemployment-data.csv')
    ...
    df.to_csv('unemployment_scraper/unemployment-data.csv',index= False)
...
def scrape():
    ...
    url = 'https://www.forecasts.org/unemploy.htm'
